...
- d72ae63: Variable-height list virtualization and native-driven pinch/rotate gestures.
...
- a6dd93b: Devtools, image picking, and a native-component escape hatch.
...
- 0f1863f: List virtualization and native-driven gestures.
...
- 9b21e89: New `VSVG` component for rendering Scalable Vector Graphics natively (vector-crisp at any resolution).
