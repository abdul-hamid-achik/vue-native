<template>
  <VView :style="styles.container">
    ...
    <VScrollView :style="styles.scroll">
      <!-- Example 1: Custom Haptics -->
      <VView :style="styles.section">
        <VText :style="styles.sectionTitle">1. Custom Haptics</VText>
        ...
        <VButton
          title="Light Vibrate"
          :style="styles.button"
          @press="handleLightVibrate"
        />
        <VButton
          title="Heavy Vibrate"
          :style="styles.button"
          @press="handleHeavyVibrate"
        />
        <VButton
          title="Pattern"
          :style="styles.button"
      ...
      <VView :style="styles.section">
        <VText :style="styles.sectionTitle">2. Image Processor</VText>
        <VText :style="styles.description">
      ...
      <VView :style="styles.section">
        <VText :style="styles.sectionTitle">3. Device Info</VText>
        <VText :style="styles.description">
        ...
        <VButton
          ...
          :style="styles.button"
          @press="handleDeviceModel"
        />
        <VText v-if="deviceInfo" :style="styles.result">
          {{ deviceInfo }}
        </VText>
      </VView>
    </VScrollView>
...
// These will be auto-generated from <native> blocks
    ...
    override fun invoke(method: String, args: List&lt;Any&gt;, callback: (Any?, String?) -> Unit) {
        when (method) {
            ...
            "pattern" -> {
                ...
                val pattern = args[0] as? List&lt;Int&gt; ?: emptyList()
                playPattern(pattern)
                callback(null, null)
            }
...
class ImageProcessorModule: NativeModule {
    ...
    override fun invoke(method: String, args: List&lt;Any&gt;, callback: (Any?, String?) -> Unit) {
        when (method) {
            "applyFilter" -> {
                ...
                @Suppress("UNCHECKED_CAST")
                val options = args[1] as? Map&lt;String, Any&gt; ?: emptyMap()
    ...
    private fun applyFilter(name: String, options: Map&lt;String, Any&gt;): String? {
