...
object Tags {
    ...
    const val NATIVE_DRIVEN_GESTURES = 0x7F_FF_0050
    const val FLAT_LIST_INDEX = 0x7F_FF_0060
    const val FLAT_LIST_HANDLER = 0x7F_FF_0061
    const val FLAT_LIST_LAYOUT_LISTENER = 0x7F_FF_0062
    const val TRANSFORM_MATRIX_LISTENER = 0x7F_FF_0070
    const val TRANSFORM_LIST = 0x7F_FF_0071
    const val TRANSFORM_APPLIED_MATRIX = 0x7F_FF_0072
}
...
const val TAG_NATIVE_DRIVEN_GESTURES = Tags.NATIVE_DRIVEN_GESTURES
const val TAG_FLAT_LIST_INDEX = Tags.FLAT_LIST_INDEX
const val TAG_FLAT_LIST_HANDLER = Tags.FLAT_LIST_HANDLER
const val TAG_FLAT_LIST_LAYOUT_LISTENER = Tags.FLAT_LIST_LAYOUT_LISTENER
const val TAG_TRANSFORM_MATRIX_LISTENER = Tags.TRANSFORM_MATRIX_LISTENER
const val TAG_TRANSFORM_LIST = Tags.TRANSFORM_LIST
const val TAG_TRANSFORM_APPLIED_MATRIX = Tags.TRANSFORM_APPLIED_MATRIX
